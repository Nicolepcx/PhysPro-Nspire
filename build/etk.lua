...
print("Removing source headers")
assert(os.execute("sed \"/--@@/ d\" big.main.lua > build/PhysPro.src.lua"), "Failed to remove source headers")
print("Removed source headers")
...
assert(os.execute("rm big.main.lua"), "Failed to cleanup temp files")
