...
{key="R",   info="Gas constant",                val="8.314",                unit="J/((mol"..s.s1h..")*(K"..s.s1h.."))"},
{key="k1",  info="Boltzmann's constant",        val="1.38*10^(-23)",        unit="J/K"..s.s1h},
{key="k2",  info="Stefan-Boltzmann constant",   val="5.67*10^-8",           unit="W*m"..s.s2h.."*K"..s.s1h},
{key="k3",  info="Coulomb constant",            val="8.99*10^9",            unit="N*m"..s.s2.."*C"..s.s2h},
